...
ru:{name:"Русский",norm:nRu,
  ...
  btn:"Поиск",clbl:"Часто ищут",empty:"Введите название отходов для поиска.",res:"Результат поиска",not:"Совпадений не найдено.",nf:q=>`По запросу "${q}" ничего не найдено.`,tip:"Введите название отходов.",cat:"Категория",how:"Способ утилизации",fine:"Нарушение правил вывоза отходов может привести к штрафу до 1 000 000 вон.",
