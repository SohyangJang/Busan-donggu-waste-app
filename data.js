...
ko:{name:"한국어",norm:nKo,
  ...
  db:[
    ...
    {t:["고추씨","고추씨앗","고추대","쪽파뿌리","미나리뿌리","옥수수대","왕겨","완두콩껍질","완두콩꼬투리","호랑이콩껍질","살구씨","감씨","아보카도씨","소라껍데기","꼬막껍데기","멍게껍데기","가재껍데기","복어내장","오리알껍데기","타조알껍데기","육수팩","다시팩","거름망"],c:"general",d:"동물이 섭취하기 어려운 씨앗·껍질·부산물",s:["종량제봉투에 배출","단단하거나 섬유질이 많아 음식물쓰레기 불가"]},
