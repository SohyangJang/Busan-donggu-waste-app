...
ko:{name:"한국어",norm:nKo,
  ...
  db:[
    ...
    {t:["호두껍질","밤껍질","땅콩껍질","도토리껍질","견과류껍질","마카다미아껍질"],c:"general",d:"견과류 껍질 (호두·밤·땅콩·도토리·마카다미아)",s:["종량제봉투에 넣어 배출"]},
    {t:["호두","밤","땅콩","도토리","마카다미아","땅콩알맹이","마카다미아알맹이","견과류알맹이"],c:"food",d:"견과류 알맹이(호두·밤·땅콩·도토리·마카다미아)",s:["음식물쓰레기 전용용기에 배출"]},
...
en:{name:"English",norm:nEn,
  ...
  db:[
    ...
    {t:["walnut shell","chestnut shell","peanut shell","nut shell","acorn shell","macadamia shell","macadamia nut shell"],c:"general",d:"Nut shells (walnut, chestnut, peanut, acorn, macadamia)",s:["Place in standard waste bag (종량제봉투)"]},
    {t:["walnut","chestnut","peanut","acorn","macadamia","peanut kernel","macadamia kernel","nut kernels"],c:"food",d:"Nut kernels (walnut, chestnut, peanut, acorn, macadamia)",s:["Place in food waste container (음식물쓰레기 전용용기)"]},
...
zh:{name:"中文",norm:nZh,
  ...
  db:[
    ...
    {t:["核桃壳","栗子壳","花生壳","坚果壳","橡子壳","夏威夷果壳","澳洲坚果壳"],c:"general",d:"坚果壳（核桃·栗子·花生·橡子·夏威夷果）",s:["放入计量垃圾袋 (종량제봉투)"]},
    {t:["核桃","栗子","花生","橡子","夏威夷果","澳洲坚果","花生仁","夏威夷果仁","坚果仁"],c:"food",d:"坚果仁（核桃·栗子·花生·橡子·夏威夷果）",s:["放入厨余垃圾专用容器 (음식물쓰레기 전용용기)"]},
...
vi:{name:"Tiếng Việt",norm:nVi,
  ...
  db:[
    ...
    {t:["vo hat","vỏ hạt","vo oc cho","vỏ óc chó","vo lac","vỏ lạc","vo dau phong","vỏ đậu phộng","vỏ mắc ca","vỏ hạt mắc ca"],c:"general",d:"Vỏ hạt cứng (óc chó, hạt dẻ, lạc, mắc ca...)",s:["Bỏ vào Túi rác tiêu chuẩn (종량제봉투)"]},
    {t:["oc cho","óc chó","hat de","hạt dẻ","lac","lạc","dau phong","đậu phộng","hat mac ca","hạt mắc ca","nhan hat","nhân hạt"],c:"food",d:"Nhân các loại hạt (óc chó, hạt dẻ, đậu phộng, mắc ca...)",s:["Bỏ vào dụng cụ đựng rác thực phẩm (음식물쓰레기 전용용기)"]},
...
ru:{name:"Русский",norm:nRu,
 ...
 sg: ["яичная скорлупа","рыбная кость","кимчи","банановая кожура","куриная кость","кофейная гуща","хлеб","арбуз","отработанное растительное масло","твенджан","варёный рис","пекинская капуста"],
  db:[
...
{t:["скорлупа грецкого ореха","скорлупа каштана","скорлупа арахиса","скорлупа желудя","ореховая скорлупа","скорлупа макадамии"],c:"general",d:"Скорлупа орехов (грецкий орех, каштан, арахис, желудь, макадамия)",s:["Выбрасывать в платный пакет"]},

{t:["грецкий орех","каштан","арахис","жёлудь","макадамия","ядро арахиса","ядро макадамии","ореховые ядра"],c:"food",d:"Ореховые ядра (грецкий орех, каштан, арахис, жёлудь, макадамия)",s:["Выбрасывать в контейнер для пищевых отходов"]},
