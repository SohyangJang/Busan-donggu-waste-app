...
zh:{name:"中文",norm:nZh,
  ...
  db:[
    ...
    {t:["辣椒籽","辣椒种子","辣椒梗","小葱根","水芹根","玉米秆","稻壳","豌豆荚","豌豆壳","扁豆壳"],c:"general",d:"动物难以食用的硬壳、根茎及纤维质部分",s:["放入普通垃圾袋 (종량제봉투)","质地坚硬或纤维过多，不属于食物垃圾"]},
