...
ru:{name:"Русский",norm:nRu,
  ui:{h1:"Сложно разобраться с мусором? Проверьте сразу",sub:"Введите название отходов и узнайте, относится ли оно к пищевым отходам, платным пакетам или специальной утилизации.",slb:"Поиск по названию",ph:"Например: арбуз, яичная скорлупа, лампа",btn:"Поиск",
