...
ko:{name:"한국어",norm:nKo,
  ...
  db:[
    ...
    {t:["고추씨","고추씨앗","고추대","쪽파뿌리","미나리뿌리","옥수수대","왕겨","완두콩껍질","완두콩꼬투리","호랑이콩껍질"],c:"general",d:"동물이 섭취하기 어려운 껍질",s:["종량제봉투에 배출","단단하거나 섬유질이 많아 음식물쓰레기 불가"]},
...
zh:{name:"中文",norm:nZh,
  ...
  db:[
    ...
    {t:["葱叶","葱茎","蔬菜碎","软质蔬菜"],c:"food",d:"葱叶·葱茎及软质蔬菜碎",s:["根部/外皮 → 计量垃圾袋","软质部分挤干后放入食物垃圾袋 (음식물쓰레기봉투)"]},
    {t:["蛋液","蛋黄","蛋白","鸡蛋"],c:"food",d:"蛋液（仅蛋壳内部分）",s:["蛋壳 → 计量垃圾袋","蛋液放入食物垃圾袋 (음식물쓰레기봉투)"]},
    ...
    {t:["脂肪","生肉","肉碎","肉"],c:"food",d:"修剪脂肪和生肉碎",s:["大骨头 → 计量垃圾袋","小块软肉和脂肪 → 食物垃圾袋 (음식물쓰레기봉투)"]},
    {t:["鱼内脏","鱼肠","软质鱼肉","鱼"],c:"food",d:"鱼内脏和软质鱼肉",s:["鱼骨·鱼鳍 → 计量垃圾袋","软质部分 → 食物垃圾袋 (음식물쓰레기봉투)"]},
...
ru:{name:"Русский",norm,
  ui:{h1:"Сложно разобраться с мусором?Проверьте сразу",sub:"Введите название отходов и узнайте, относится ли оно к пищевым отходам, платным пакетам или специальной утилизации.",slb:"Поиск по названию",ph:"Например: арбуз, яичная скорлупа, лампа",
btn:"Поиск",res:"Результат поиска",not:"Совпадений не найдено.",tip:"Введите название отходов.",cat:"Категория",how:"Способ утилизации",fine:"Нарушение правил вывоза отходов может привести к штрафу до 1 000 000 вон.",
call:"Контакты",schedule:"График вывоза отходов"},
  sg:["общий мусор","платный пакет","обычный мусор","не пищевые отходы"],
  db:[
    {c:"general",t:"бумажный стакан одноразовый стакан стакан для кофе",d:"Одноразовые бумажные стаканы с покрытием",s:"Выбрасывать в платный пакет для мусора."},
    {c:"general",t:"салфетка бумажная салфетки использованная салфетка",d:"Использованные салфетки и загрязнённая бумага",s:"Выбрасывать в платный пакет для мусора."},
    {c:"general",t:"чек кассовый чек бумага термобумага",d:"Кассовые чеки и термобумага",s:"Выбрасывать в платный пакет для мусора."},
    {c:"general",t:"подгузник памперс детский подгузник",d:"Подгузники и средства гигиены",s:"Удалить содержимое и выбросить в платный пакет."},
    {c:"general",t:"маска медицинская маска одноразовая маска",d:"Использованные маски",s:"Выбрасывать в платный пакет для мусора."},

{
  c:"general",
  t:"зубная щетка зубная щётка щетка",
  d:"Зубные щётки",
  s:"Выбрасывать в платный пакет для мусора."
},

{
  c:"general",
  t:"соломинка трубочка пластиковая трубочка",
  d:"Соломинки и трубочки",
  s:"Выбрасывать в платный пакет для мусора."
},

{
  c:"general",
  t:"зеркало разбитое зеркало зеркало",
  d:"Зеркала",
  s:"Завернуть для безопасности и выбросить в платный пакет."
},

{
  c:"general",
  t:"лампа накаливания лампочка",
  d:"Лампы накаливания",
  s:"Завернуть и выбросить в платный пакет."
},

{
  c:"general",
  t:"керамика чашка тарелка фарфор",
  d:"Керамика, фарфор и глиняная посуда",
  s:"Завернуть и выбросить в платный пакет."
}
